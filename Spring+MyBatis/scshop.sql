/*
 ...
 Source Server         : 127.0.0.1-MySQL-3309
 Source Server Type    : MySQL
 Source Server Version : 50561
 Source Host           : localhost:3309
 Source Schema         : sgshop

 Target Server Type    : MySQL
 Target Server Version : 50561
 File Encoding         : 65001

 Date: 11/04/2021 21:01:15
*/
...
) ENGINE = InnoDB AUTO_INCREMENT = 21 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '购物车表' ROW_FORMAT = Compact;

-- ----------------------------
-- Records of car
-- ----------------------------
INSERT INTO `car` VALUES (18, 29, 2, 1, 39.93, '39.93');
INSERT INTO `car` VALUES (20, 35, 2, 1, 22.50, '22.5');
...
INSERT INTO `comment` VALUES (9, 2, 29, '味道不错，挺甜的', '2021-04-08 01:08:45');
...
CREATE TABLE `item`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 37 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '商品表' ROW_FORMAT = Compact;
...
INSERT INTO `item` VALUES (29, '2017山东新鲜红富士苹果', '49.9', 0, 1, '\\resource\\ueditor\\upload\\d86ea98097c311eb8f0b5f849acdeebasrc=http _image4.suning.cn_uimg_b2c_newcatentries_0070159738-000000000606941944_5_800x800.jpg&refer=http _image4.suning.cn&app=2002&size=f9999,10000&q=a80&n=0&g=0n&fmt=jpeg.jpg', '\\resource\\ueditor\\upload\\d86ef7a097c311eb8f0b5f849acdeeba', '\\resource\\ueditor\\upload\\d86f1eb097c311eb8f0b5f849acdeeba', '\\resource\\ueditor\\upload\\d86f1eb197c311eb8f0b5f849acdeeba', '\\resource\\ueditor\\upload\\d86f1eb297c311eb8f0b5f849acdeeba', '<p><img src=\"/test1_war_exploded/resource/ueditor/upload/d41f73a097c311eb8f0b5f849acdeebasrc=http _image4.suning.cn_uimg_b2c_newcatentries_0070159738-000000000606941944_5_800x800.jpg&refer=http _image4.suning.cn&app=2002&size=f9999,10000&q=a80&n=0&g=0n&fmt=jpeg.jpg\" title=\"\" alt=\"src=http _image4.suning.cn_uimg_b2c_newcatentries_0070159738-000000000606941944_5_800x800.jpg&amp;refer=http _image4.suning.cn&amp;app=2002&amp;size=f9999,10000&amp;q=a80&amp;n=0&amp;g=0n&amp;fmt=jpeg.jpg\"/></p>', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 8, 75, 76, 0);
...
INSERT INTO `item` VALUES (35, '新鲜油桃5斤 新鲜孕妇水果非水蜜桃黄桃毛桃子樱桃当季时令鲜果', '25', 1, 8, '\\resource\\ueditor\\upload\\25ec4f0097c411eb8f0b5f849acdeebasrc=http _file.youboy.com_a_102_37_25_0_10466380.jpg&refer=http _file.youboy.com&app=2002&size=f9999,10000&q=a80&n=0&g=0n&fmt=jpeg.jpg', '\\resource\\ueditor\\upload\\25ecc43097c411eb8f0b5f849acdeeba', '\\resource\\ueditor\\upload\\25eceb4097c411eb8f0b5f849acdeeba', '\\resource\\ueditor\\upload\\25eceb4197c411eb8f0b5f849acdeeba', '\\resource\\ueditor\\upload\\25eceb4297c411eb8f0b5f849acdeeba', '<p><img src=\"/test1_war_exploded/resource/ueditor/upload/407173802c2111e865b6dc2da7582a7aTB2d_RhaKuSBuNjy1XcXXcYjFXa_!!2102024380.jpg_430x430q90.jpg\" title=\"\" alt=\"TB2d_RhaKuSBuNjy1XcXXcYjFXa_!!2102024380.jpg_430x430q90.jpg\"/></p>', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 9, 73, 74, 0);
INSERT INTO `item` VALUES (36, '现摘3斤 黄瓜 新鲜蔬菜包邮现货新摘', '5', 3, 3, '\\resource\\ueditor\\upload\\5b5f77309ac511eb565722177bdf1747黄瓜.jpg', '\\resource\\ueditor\\upload\\5b5f9e409ac511eb565722177bdf1747黄瓜.jpg', '\\resource\\ueditor\\upload\\5b5f9e419ac511eb565722177bdf1747黄瓜.jpg', '\\resource\\ueditor\\upload\\5b5fc5509ac511eb565722177bdf1747黄瓜.jpg', '\\resource\\ueditor\\upload\\5b5fec609ac511eb565722177bdf1747黄瓜.jpg', '<p>新鲜黄瓜<br/></p><p>新鲜黄瓜<br/></p><p>新鲜黄瓜<br/></p><p>新鲜黄瓜<br/></p><p>新鲜黄瓜<br/></p><p>新鲜黄瓜<br/></p><p>新鲜黄瓜<br/></p><p>新鲜黄瓜<br/></p><p>新鲜黄瓜<br/></p><p>新鲜黄瓜<br/></p><p>新鲜黄瓜<br/></p><p><br/></p>', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 9, 83, 84, 0);
...
CREATE TABLE `item_category`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 85 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '商品种类表' ROW_FORMAT = Compact;
...
INSERT INTO `item_category` VALUES (82, 'dd', NULL, 1);
INSERT INTO `item_category` VALUES (83, '新鲜黄瓜', NULL, 0);
INSERT INTO `item_category` VALUES (84, '新鲜黄瓜', 83, 0);
...
CREATE TABLE `item_order`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 34 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '订单表' ROW_FORMAT = Compact;
...
INSERT INTO `item_order` VALUES (33, NULL, 2, '2021040800530001', '2021-04-08 00:53:15', '39.93', 0, 3);
...
CREATE TABLE `message`  (
  ...
  `content` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '留言表' ROW_FORMAT = Compact;
...
INSERT INTO `news` VALUES (7, '1111', '<p>1111111</p>', '2021-04-08 01:02:50');
...
CREATE TABLE `order_detail`  (
  ...
  `total` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 69 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '订单详情表' ROW_FORMAT = Compact;
...
INSERT INTO `order_detail` VALUES (68, 29, 33, 0, 1, '39.93');
...
CREATE TABLE `sc`  (
  ...
  `user_id` int(11) NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 23 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '收藏表' ROW_FORMAT = Compact;
...
INSERT INTO `sc` VALUES (19, 36, 2);
INSERT INTO `sc` VALUES (21, 36, 2);
INSERT INTO `sc` VALUES (22, 35, 2);
...
INSERT INTO `user` VALUES (2, 'dd', '111111', 'dd', 'dd', '女', 'dddddd', '');
